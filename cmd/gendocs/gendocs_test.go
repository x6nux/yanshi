...
func TestSubcommandListMatchesDispatch(t *testing.T) {
	...
	want := []string{"yanshi", "serve", "chat", "exec", "app", "goal", "vcs-mcp", "mcp", "init", "daemon", "schedule", "provider", "models", "acp", "pr", "enqueue", "auth", "doctor", "ipc", "session", "usage", "skills", "features", "approvals", "jobs", "vcs"}
	...
	for _, required := range []string{"serve", "chat", "exec", "app", "goal", "vcs-mcp", "mcp", "init", "daemon", "schedule", "provider", "models", "acp", "pr", "enqueue", "auth", "doctor", "ipc", "session", "usage", "skills", "features", "approvals", "jobs", "vcs"} {
