...
var acceptancePins = map[string]acceptancePin{
	...
	"A2/W-A-02":  {Clauses: 5, Digest: "254775b4f67a683d"},
	"A2/W-A-03":  {Clauses: 4, Digest: "0647625b4dcb8587"},
	"A2/W-A-04":  {Clauses: 4, Digest: "b5e1858c89e70f8c"},
	"A2/W-A-05":  {Clauses: 3, Digest: "cff19c79fdb00fd0"},
	"A2/W-A-06":  {Clauses: 4, Digest: "be40120383fdd8a8"},
	"A2/W-A-08":  {Clauses: 4, Digest: "df2c727bbc3def06"},
	...
	// 2026-08-07: acceptance rewritten, 5 clauses → 3. The original was a
	// meta-statement — "the roadmap gave no acceptance criteria for B0, only
	// this note in the measurement table: '…'" — and two of the five clauses
	// it split into were not behavioural at all: one described a missing
	// document, the other named TestLoop_BudgetStopsOnAccumulatedUsage as the
	// acceptance, which is self-referential. GOV8's clause-level handshake had
	// nowhere to land on either, so the entry could never leave partial
	// regardless of the code (same shape as F2/CCL1#3). The new text
	// translates that measurement note into three assertable claims with the
	// same coverage.
	"B0/TD1":   {Clauses: 3, Digest: "eb1e6002d1c8f143"},
	...
	"C2/UX4":   {Clauses: 3, Digest: "fec8dcb2b2e3615c"},
	...
	"D1/APS1":  {Clauses: 3, Digest: "5d131d16cd717444"},
	"D1/V12":   {Clauses: 4, Digest: "84723d634f3afc79"},
	"D1/V14":   {Clauses: 3, Digest: "40a39b27637726e0"},
	"D2/O12":   {Clauses: 2, Digest: "b070e9ce4b3b6937"},
	"D2/V15":   {Clauses: 3, Digest: "39e775e2ffd58479"},
	...
	// 2026-08-04：第 5 句原文以字面省略号「Windows -r…」结尾，plan 的第 10 条细化
