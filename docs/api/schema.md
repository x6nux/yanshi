...
```json
{
  ...
  "description": "Provisional v1 contract mirror of internal/api/v1/types.go. D1 serves the canonical schema at GET /api/v1/schema/agent-v1.json; this document is the SDK-handoff copy that adds D2-provisional IDE-context extensions (ContextItem, FileChange). Replace this file when D1 publishes the canonical schema.",
